                ...
                <div class="result-container">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value"><%= f.getCargo().getNome() %></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Função</div>
                            <div class="info-value"><%= f.getCargo().getFuncao() %></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Salário Base</div>
                            <div class="info-value">R$ <%= f.getCargo().getSalarioBase() %></div>
                        </div>
                        <% } %>
                    ...
                    <div style="margin-top: 25px; display: flex; gap: 10px;">
                        <a href="FuncionarioControllerAtualizar?id_fun=<%= f.getId_Fun() %>" class="btn btn-edit">Editar</a>
                        <form action="FuncionarioControllerDeletar" method="post" style="display: inline;">
                            <input type="hidden" name="op" value="DELETAR_FUNCIONARIO">
