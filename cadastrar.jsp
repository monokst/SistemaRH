        ...
        <main class="main">
            ...
            <div class="form-card">
                ...
                <form action="FuncionarioControllerCadastrar" method="post">
                    <input type="hidden" name="op" value="CADASTRAR_FUNCIONARIO">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid three-cols">
                            <div class="form-group">
                                ...
                                <input type="text" id="nomeCargo" name="nomeCargo" placeholder="Ex: Estagiário" required>
                            </div>
                            <div class="form-group">
                                <label for="funcao">Função</label>
                                <input type="text" id="funcao" name="funcao" placeholder="Ex: Desenvolvedor" required>
                            </div>
                            <div class="form-group">
                                <label for="salarioBase">Salário Base (R$)</label>
                                <input type="number" step="0.01" id="salarioBase" name="salarioBase" placeholder="1200.00" required>
                            </div>
                        </div>
