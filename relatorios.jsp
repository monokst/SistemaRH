...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="FuncionarioControllerConsultarTodos?op=CONSULTAR_TODOS_FUNCIONARIO"><span class="icon">👤</span> Funcionários</a></li>
            <li><a href="RelatorioController?op=DASHBOARD" class="active"><span class="icon">📊</span> Relatórios</a></li>
        </ul>
        <div class="sidebar-footer">
            <a href="logouthome"><span class="icon">🚪</span> Sair</a>
        </div>
    </aside>
    ...
    <main class="main-content">
        ...
        <%
            ...
            if (lista != null) {
                ...
                for (Funcionario f : lista) {
                    ...
                    if (f.getCargo() != null) {
                        Double salario = f.getCargo().getSalarioBase();
                        if (salario != null) {
                    ...
                    String cargo = (f.getCargo() != null && f.getCargo().getNome() != null) 
                                   ? f.getCargo().getNome() : "Sem cargo";
                    porCargo.put(cargo, porCargo.getOrDefault(cargo, 0) + 1);
                }
            }
        ...
        <div class="kpi-grid">
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-card-value"><%= porCargo.size() %></div>
            </div>
        </div>
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                <div class="dashboard-card-title">💼 Funcionários por Cargo</div>
                <div class="bar-list">
                    <% 
                        String[] cores = {"bar-blue", "bar-green", "bar-purple", "bar-amber", "bar-red"};
                        int corIndex = 0;
                        for (Map.Entry<String, Integer> entry : porCargo.entrySet()) { 
